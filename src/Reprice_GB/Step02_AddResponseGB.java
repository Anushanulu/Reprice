...
public class Step02_AddResponseGB {
	...
	//Submit response
		...
		public Step02_AddResponseGB(WebDriver driver)
		{
			this.driver=driver;
...
//			btn_Add_response.click();
			...
			Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") + "\\test-output\\snaps\\UK\\");
