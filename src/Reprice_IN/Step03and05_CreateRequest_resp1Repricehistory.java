...
public class Step03and05_CreateRequest_resp1Repricehistory {
	...
	// Define the element
	/*
	 * @FindBy (xpath = ".//*[@id='content-main']/p[2]/a") private WebElement
	 * loginToContractor_Link;
	 * 
	...
	public Step03and05_CreateRequest_resp1Repricehistory(WebDriver driver) {
		this.driver = driver;
	...
	public void login() throws InterruptedException {
		...
		login_username.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 13, 0));
		Thread.sleep(1000);
		login_password.clear();
		login_password.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 13, 1));

		// Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") + "\\test-output\\snaps\\IN\\");
		login_Button.click();
		try {
	...
	public void RepriceHistoryResp2() throws InterruptedException {
		...
		wait06.until(ExpectedConditions.visibilityOf(RepriceHistory_Resp1));
		RepriceHistory_Resp1.click();

		Thread.sleep(1000);
		Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS)
				.save(System.getProperty("user.dir") + "\\test-output\\snaps\\IN\\");
