...
public class Step01_CreateRequest_US {
	...
	@FindBy ( xpath= "//*[contains(text(), 'MARVEL - 62.26 USD/HR')]//preceding-sibling::input[@name='fldSuppliers']") private WebElement Marvel_sup;
...
//		}
		...
		public void switch_country()
		{
			...
			Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") + "\\test-output\\snaps\\US\\");Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") + "\\test-output\\snaps\\US\\");
		...
		public void Skill_Request(){
			...
			//Shutterbug.shootPage(driver, ScrollStrategy.WHOLE_PAGE).save(System.getProperty("user.dir") + "\\src\\test\\resources\\Screens\\US");
			Continue.click();
			Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") + "\\test-output\\snaps\\US\\");Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") + "\\test-output\\snaps\\US\\");Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") + "\\test-output\\snaps\\US\\");
		}
