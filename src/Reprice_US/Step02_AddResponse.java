...
public class Step02_AddResponse {
	...
	//Submit response
		...
		@FindBy (xpath="//span[contains(text(),'Lowest supplier rate :')]") private WebElement Lowest_Sup_Rate;
		@FindBy (xpath="//span[contains(text(),'My lowest submitted rate :')]") private WebElement My_Lowest_Sub_Rate;
...
//			wait13.until(ExpectedConditions.visibilityOf(enddt_Calender));
		...
		public void resRates(String STRate, String STWage)
		{
			JavascriptExecutor js = (JavascriptExecutor)driver;
