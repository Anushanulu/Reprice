...
public class Step03_Response2_Reprice {
	...
	@FindBy(xpath = "//div[@class='bx--list-box__menu-item__option' and contains(text(), 'United States')]")
	...
	public void openRequest() throws InterruptedException {
		...
		// ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") +
		// "\\test-output\\snaps\\US\\");
	...
	public void resDetails(String First_Name_temp, String Middle_Name_temp, String LastName_Surname_temp)
	...
	// public void resDetails() throws IOException, InterruptedException
	{
		...
		// driver.findElements(By.xpath(Citizenship)); // To find the dropdown
		// options
	...
	public void saveForm() throws InterruptedException {
		...
		// wait18.until(ExpectedConditions.elementToBeClickable((By)
		// redy_submission_chkbox));
		// redy_submission_chkbox.click();
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", SelectAll_Checkbox);

		// List<WebElement> options =
		// driver.findElements(By.xpath(redy_submission_chkbox)); // To find the
		// dropdown options
		// //ele.click(); // To click on the dropdown element
		// for(int i=0;i<=options.size();i++)
		// {
