...
public class Step05_Response1_Reprice {
	...
	//Submit response
		...
		@FindBy (xpath ="//td[@class='rowCell']/a") private WebElement skilllink_toReprice ;
		
		@FindBy (xpath ="//div[@class='button-div-footer']//button[@class='bx--btn bx--btn--primary ng-star-inserted'][normalize-space()='Reprice']") private WebElement Reprice_btn;
		

		@FindBy (xpath="//span[contains(text(),'Lowest supplier rate :')]/parent::div/following-sibling::div//span[@class='content-text']") private WebElement Lowest_Sup_Rate_val;
		@FindBy (xpath="//span[contains(text(),'My lowest submitted rate :')]/parent::div/following-sibling::div//span[@class='content-text']") private WebElement My_Lowest_Sub_Rate_val;
		
		
		// Initialize the web elements 
		public Step05_Response1_Reprice(WebDriver driver)
		{
			this.driver=driver;
		...
		public void openRequest() throws InterruptedException
		{
			...
			//Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save(System.getProperty("user.dir") + "\\test-output\\snaps\\US\\");
