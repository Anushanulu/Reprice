...
import Reprice_US.Step03_Response2_Reprice;
...
public class Response2_Reprice {
	...
	public void resp2login() throws IOException, InterruptedException {
		...
		Step03_Response2_Reprice reprice = new Step03_Response2_Reprice(driver);
		reprice.login("marvel@ibm.com", "csa2test");

		reprice.openRequest();
		reprice.alertcall();
		reprice.RepriceSkill();
	}
